    ...
    void Update()
    {
        ...
        for (int i = 0; i < size; i++)
        {
            ...
            if (warp)
            {
                ...
                lrComp.SetPosition(i, new Vector3(length / size * i - start, sinAngle * ampT * warpT, sinAngleZ * ampT * warpT));
            }
            else
            {
                lrComp.SetPosition(i, new Vector3(length / size * i - start, sinAngle * ampT, sinAngleZ * ampT));
                warpInvert = false;
            }
